 ...
 * 
 * @param {browser.declarativeNetRequest.Rule} rule The rule whose edit button was clicked
 */
 ...
 * 
 * @param {browser.declarativeNetRequest.Rule} rule The rule object to create an element for. Also contains the "enabled" and optionally the "group" fields used by the extension
